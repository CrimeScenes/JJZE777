...
local function isPartInFovAndVisible(part)
    ...
    -- Dynamically calculate the FOV based on X, Y, Z values
    local dynamicFovSize = calculateFov(shared.Forbidden.Silent.BoundingSizes.X, shared.Forbidden.Silent.BoundingSizes.Y, shared.Forbidden.Silent.BoundingSizes.Z)
